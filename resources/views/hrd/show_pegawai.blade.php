                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-center">{{$show->jabatan}}</p>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                @if (!empty($show->pend_ditempuh))
                                    <p class="text-muted">
                                        {{$show->pend_terakhir}} saat ini menempuh {{$show->pend_ditempuh}}
                                    </p>
                                @else
                                    <p class="text-muted">
                                        {{$show->pend_terakhir}}
                                ...
                                <p class="text-muted">{{$show->alamat}}</p>
                                ...
                                <p class="text-muted">{{$show->email}} | {{$show->telepon}}</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
